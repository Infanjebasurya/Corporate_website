...
export default function CookieConsentBanner() {
  ...
  return (
    <div className="pointer-events-none fixed inset-x-0 bottom-0 z-[70] px-4 pb-4 sm:bottom-3 sm:px-6">
      <div
        className={`pointer-events-auto mx-auto max-w-[1200px] transform-gpu transition-all duration-500 ease-out ${
      ...
      >
        <div className="relative overflow-hidden rounded-2xl border border-slate-200/80 bg-white/95 shadow-2xl backdrop-blur-xl">
          <div className="relative px-5 py-2.5 sm:px-6 sm:py-3 lg:px-7 lg:py-3.5">
            <div className="flex flex-col gap-2 lg:flex-row lg:items-center lg:justify-between lg:gap-4">
              <div className="flex items-start gap-3 sm:gap-4">
                <div className="relative flex size-10 shrink-0 items-center justify-center rounded-full bg-gradient-to-br from-indigo-50 to-sky-50 shadow sm:size-12">
                  <svg width="22" height="22" viewBox="0 0 44 44" aria-hidden="true" className="text-indigo-500">
                    <path
                      fill="currentColor"
                ...
                <div className="flex-1">
                  <h3 className="text-sm font-semibold text-slate-800 sm:text-base">Cookie preferences</h3>
                  <p className="mt-0.5 max-w-[650px] text-xs leading-relaxed text-slate-600 sm:text-sm">
              ...
              <div className="flex items-center justify-end gap-2">
                <button
                  type="button"
                  className="rounded-full border border-slate-200 bg-white px-4 py-1.5 text-xs font-medium text-slate-700 shadow-sm transition-all duration-300 hover:border-indigo-200 hover:bg-indigo-50 hover:text-indigo-700 sm:px-5 sm:py-2 sm:text-sm"
                  onClick={onRejectAll}
                >
                  Reject all
                </button>
                ...
                <button
                  type="button"
                  className="rounded-full bg-gradient-to-r from-indigo-600 to-indigo-500 px-4 py-1.5 text-xs font-medium text-white shadow-lg shadow-indigo-500/25 transition-all duration-300 hover:from-indigo-500 hover:to-indigo-600 sm:px-5 sm:py-2 sm:text-sm"
                  onClick={onAcceptAll}
                >
                  Accept all
                </button>
              ...
              {showCustomize && (
                <div className="mt-2 rounded-xl border border-slate-200 bg-slate-50/80 p-3">
                  <div className="grid gap-2">
                    <div className="flex items-center justify-between gap-4 rounded-lg bg-white p-2.5">
                      <div>
                        <div className="text-sm font-semibold text-slate-900">Essential cookies</div>
                        <div className="mt-0.5 text-xs text-slate-600">Required for basic site functionality.</div>
                      </div>
                    ...
                    <div className="flex items-center justify-between gap-4 rounded-lg bg-white p-2.5">
                      <div>
                        ...
                        <div className="mt-0.5 text-xs text-slate-600">Help us measure usage and improve the experience.</div>
                      </div>
                      <Toggle
                    ...
                    <div className="flex items-center justify-between gap-4 rounded-lg bg-white p-2.5">
                      <div>
                        ...
                        <div className="mt-0.5 text-xs text-slate-600">Used to personalize campaigns and promotions.</div>
                      </div>
                      <Toggle
                  ...
                  <div className="mt-3 flex justify-end">
                    <button
                      type="button"
                      className="rounded-full bg-slate-900 px-4 py-1.5 text-sm font-medium text-white transition hover:bg-slate-800 sm:px-5 sm:py-2"
