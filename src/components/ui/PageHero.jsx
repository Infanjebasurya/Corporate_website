  ...
  return (
    <div
        className={
          ...
          : 'rounded-2xl border border-white/80 bg-white/88 px-4 py-4 shadow-[0_14px_30px_rgba(15,23,42,0.06)] backdrop-blur'
        }
      >
      <div
        className={
      ...
      <div
        className={
          isDark
            ...
            : 'absolute inset-x-0 top-0 -z-10 h-[440px] bg-[radial-gradient(circle_at_top_left,rgba(99,102,241,0.2),transparent_34%),radial-gradient(circle_at_top_right,rgba(14,165,233,0.16),transparent_30%),linear-gradient(180deg,rgba(255,255,255,0.98)_0%,rgba(248,250,252,0.95)_46%,rgba(248,250,252,0)_100%)]'
        }
      />
      <Container>
        <Reveal>
          <div
            className={
              isDark
                ...
                : 'rounded-[2rem] border border-white/80 bg-white/88 p-8 shadow-[0_24px_60px_rgba(15,23,42,0.08)] backdrop-blur-xl sm:p-10 lg:p-12'
            }
          >
